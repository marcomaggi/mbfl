...
mbfl_declare_action_set MAIN_ONE
mbfl_declare_action MAIN_ONE RED  NONE red  'Do main action one red.'
mbfl_declare_action MAIN_ONE BLUE NONE blue 'Do main action one blue.'

mbfl_declare_action_set MAIN_TWO
mbfl_declare_action MAIN_TWO GREEN NONE green 'Do main action one green.'
mbfl_declare_action MAIN_TWO CYAN  NONE cyan  'Do main action one cyan.'

mbfl_declare_action_set MAIN
mbfl_declare_action MAIN ONE  MAIN_ONE one  'Do main action one.'
mbfl_declare_action MAIN TWO  MAIN_TWO two  'Do main action two.'
mbfl_declare_action MAIN HELP NONE     help 'Do main action help.'

function script_before_parsing_options_RED () {
    script_USAGE="usage: ${script_PROGNAME} red [options]"
    script_DESCRIPTION='Example action tree: red.'
...
function script_before_parsing_options_BLUE () {
    script_USAGE="usage: ${script_PROGNAME} blue [options]"
    script_DESCRIPTION='Example action tree: blue.'
...
function script_before_parsing_options_GREEN () {
    script_USAGE="usage: ${script_PROGNAME} green [options]"
    script_DESCRIPTION='Example action tree: green.'
    mbfl_declare_option ALPHA no a alpha noarg 'Enable option alpha.'
    mbfl_declare_option BETA  '' b beta  witharg 'Set option beta.'
}
function script_before_parsing_options_CYAN () {
    script_USAGE="usage: ${script_PROGNAME} cyan [options]"
    script_DESCRIPTION='Example action tree: cyan.'
    mbfl_declare_option DELTA no d delta noarg 'Enable option delta.'
    mbfl_declare_option GAMMA '' g gamma witharg 'Set option gamma.'
}
